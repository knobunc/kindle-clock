...
do_update() {
    ...
    # Update all of the files in conf and completely replace them with the new stuff
    add_status "Updating conf...         "
    /usr/bin/rsync $RSYNC_OPTIONS --delete-delay --delay-updates "${RSYNC_SOURCE}/conf/" conf
