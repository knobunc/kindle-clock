...
$font_path = "LinLibertine_RZah";
$font_path_bold = "LinLibertine_RBah";
$creditFont = "LinLibertine_RZIah";
$image_path = "../timelit/";
...
function TurnQuoteIntoImage($time, $quote, $timestring, $title, $author) {
    ...
    // Save the image
    imagepng($png_image, $image_path.'images/quote_'.$time.'_'.$imagenumber.'.png');
    ...
    imagepng($png_image, $image_path.'images/metadata/quote_'.$time.'_'.$imagenumber.'_credits.png');
    ...
    $im = new Imagick();
    $im->readImage($image_path.'images/quote_'.$time.'_'.$imagenumber.'.png');
    $im->setImageType(Imagick::IMGTYPE_GRAYSCALE);
    unlink($image_path.'images/quote_'.$time.'_'.$imagenumber.'.png');
    $im->writeImage($image_path.'images/quote_'.$time.'_'.$imagenumber.'.png');

    // convert the image we made to greyscale 
    $im = new Imagick();
    $im->readImage($image_path.'images/metadata/quote_'.$time.'_'.$imagenumber.'_credits.png');
    $im->setImageType(Imagick::IMGTYPE_GRAYSCALE);
    unlink($image_path.'images/metadata/quote_'.$time.'_'.$imagenumber.'_credits.png');
    $im->writeImage($image_path.'images/metadata/quote_'.$time.'_'.$imagenumber.'_credits.png');
